/**
 * Teams Chat Scraper - Small Profile
 *
 * VIKTIGT: Detta är en TEMPLATE som ska ersättas med konverterad codegen-script!
 *
 * Workflow:
 * 1. Användaren kör: scripts/run_codegen_small.bat
 * 2. Interagerar med Teams för att nå target chat
 * 3. Codegen sparar till: playwright/recorded/recorded_small_<timestamp>.ts
...
class TeamsScraperSmall extends BaseScraper {
    constructor() {
        super('small');
    }
    ...
    async extractMessages() {
        this.logger.info('Starting message extraction (SMALL profile)');
...
if (require.main === module) {
    const scraper = new TeamsScraperSmall();
...
module.exports = TeamsScraperSmall;
