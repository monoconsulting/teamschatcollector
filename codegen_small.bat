@echo off
REM ================================================================
REM Teams Collector - Quick Codegen Launcher (Small Profile)
REM ================================================================
REM Snabbstart for att spela in Teams-navigering med small profile
...
call scripts\run_codegen_small.bat
